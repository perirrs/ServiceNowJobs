...
using SNHub.Notifications.Application.Behaviors;
...
try
{
    ...
    builder.Services.AddMediatR(cfg =>
    {
        cfg.RegisterServicesFromAssembly(
            typeof(SNHub.Notifications.Application.Commands.CreateNotification
                .CreateNotificationCommand).Assembly);
        cfg.AddBehavior(typeof(IPipelineBehavior<,>), typeof(LoggingBehavior<,>));
        cfg.AddBehavior(typeof(IPipelineBehavior<,>), typeof(ValidationBehavior<,>));
    });
    builder.Services.AddValidatorsFromAssembly(
        typeof(SNHub.Notifications.Application.Commands.CreateNotification
            .CreateNotificationCommandValidator).Assembly);
    ...
    if (app.Environment.IsDevelopment() || app.Environment.IsEnvironment("Testing"))
    {
        ...
        {
            o.Title = "SNHub Notifications API";
    ...
    Log.Information("SNHub Notifications Service ready.");
    await app.RunAsync();
}
