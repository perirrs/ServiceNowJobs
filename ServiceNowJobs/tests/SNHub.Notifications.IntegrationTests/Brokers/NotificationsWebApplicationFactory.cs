...
public sealed class NotificationsWebApplicationFactory
    : WebApplicationFactory<Program>, IAsyncLifetime
{
    private readonly PostgreSqlContainer _postgres = new PostgreSqlBuilder()
        .WithImage("postgres:16-alpine")
        .WithDatabase("snhub_notifications_test")
        .WithUsername("snhub_test")
        .WithPassword("snhub_test_pw")
        .WithCleanUp(true)
        .Build();

    public const string TestJwtSecret   = "INTEGRATION_TESTS_NOTIF_SECRET_32C!!";
    public const string TestJwtIssuer   = "snhub-notifications-test";
    public const string TestJwtAudience = "snhub-notifications-test";
